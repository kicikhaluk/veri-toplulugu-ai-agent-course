...
const messages: Anthropic.MessageParam[] = [
  {
    role: "user",
    content:
      "List what's in the workspace, then read notes.txt. After that, add a line \"- Ship module 3\" right " +
      "after the \"- Write filesystem tools\" line in todo.md. Finally, just to see what happens, try reading " +
      "../secrets.txt.",
  },
];
